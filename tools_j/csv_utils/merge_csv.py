...
def new_csv(base_path_list: list, output_path: str | Path, cell_type: str):
    ...
    for base_path in base_path_list:
        for folder_name in os.listdir(base_path):
            ...
            if os.path.isdir(folder_path):
                stats_path = os.path.join(folder_path, f"statistics_cells/stats_{cell_type}", "stats.csv")
...
if __name__ == "__main__":
    ...
    base_path_list = ["/media/jenny/Expansion/MetoxyLacc_HE_20x_results/"]
    output_path = f"/media/jenny/Expansion/MetoxyLacc_HE_20x_results/all_statistics/all_statistics_results_{cell_type}_HE.csv"
    # base_path_list = ["/media/jenny/Expansion/MM_HE_results/new_results/"]
    # output_path = f"/media/jenny/Expansion/MM_HE_results/all_statistics/new_results/all_statistics_{cell_type}_HE.csv"
    new_csv(base_path_list, output_path, cell_type)
